package com.bianhua.com.Utils.updata;
...
import com.bianhua.com.Utils.Constant;
...
public class DialogUpdata  extends DialogFragment {
        ...
        buttonUpdata1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ("QZ".equals(mark)){
                    ...
                    intent_start.setClass(context, MainActivity.class);
    ...
    private void downFile(String downloadApk) {
        ViewUtils.makeToast02(""+CommonUtils.getConnectedType(context));
        if (CommonUtils.getConnectedType(context) == -1) {
            ViewUtils.makeToast02(
                    "没有可用网络！");
            return;
        }
